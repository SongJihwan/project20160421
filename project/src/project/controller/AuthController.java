...
public class AuthController {
  ...
  public void unsubscribe(Session se) {
    if (CommandUtil.confirm(keyScan, "정말 탈퇴 하시겠습니까?")) {
      try {
        ...
        System.out.println("데이터 저장하는데 실패했습니다.");
      }
    }
  }
  ...
  private void doSignUp() {
    ...
    member.setTel(value);
    try {
      if (CommandUtil.confirm(keyScan, "회원가입 하시겠습니까?")) {
  ...
  private boolean doLogin() {
    ...
    // 다른 컨트롤러가 사용할 수 있도록! 세션에 멤버정보 저장!
